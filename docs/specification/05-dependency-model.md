...
- A renderer or audio system depends — in the ordinary §5 sense — on the presentation-property contracts it reads (`CurrentAnimation`, `ParticleEffects`, a voice's audio cue), not on every gameplay capability that might contribute to them.
