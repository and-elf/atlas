...
#
# Only the Linux/SPIRV-Cross/Vulkan path is exercised end-to-end by this
# round (this project's own sandbox/CI) - see README's "Open questions" for
# why macOS/Windows remain unverified (no Microsoft-published macOS DXC
# binary at all; SDL_shadercross's own CI builds DXC from source there
# instead, a materially different path this round does not attempt).
...
if(NOT CMAKE_SYSTEM_NAME STREQUAL "Linux")
  message(
    FATAL_ERROR
      "atlas-render: ATLAS_RENDER_BACKEND=SDL3's shader tooling (issue #153) is only "
      "implemented/verified for Linux so far - Microsoft publishes no prebuilt macOS DXC "
      "binary, and SDL_shadercross's own CI builds DXC from source there instead (a "
      "materially different, unverified path here). See "
      "libraries/atlas-render/README.md's Open Questions.")
endif()
...
foreach(shadercross_target IN ITEMS SDL3_shadercross-static SDL3_shadercross-shared)
  if(TARGET ${shadercross_target})
    set_target_properties(${shadercross_target} PROPERTIES CXX_CLANG_TIDY "")
  endif()
endforeach()
